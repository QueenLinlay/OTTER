...
std::string windowTitle = "Justin_Lee_100658626_Assignment_1";
...
int main() {
	...
	camera->SetPosition(glm::vec3(0, 2, 1));   
	...
	while (!glfwWindowShouldClose(window)) {
		...
		transform4 = glm::translate(glm::mat4(1.0f), glm::vec3(1, 0.0f, glm::sin(static_cast<float>(thisFrame))));
